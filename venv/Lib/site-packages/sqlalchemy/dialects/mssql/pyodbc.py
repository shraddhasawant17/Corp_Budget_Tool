...
database using Azure credentials::
    ...
    SQL_COPT_SS_rbl_token = 1256  # Connection option for access tokens, as defined in msodbcsql.h
    ...
    def provide_token(dialect, conn_rec, cargs, cparams):
        ...
        cparams["attrs_before"] = {SQL_COPT_SS_rbl_token: token_struct}
